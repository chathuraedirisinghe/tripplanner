...
//                        onSignupSuccess();
    ...
    private void getServerRequest(final String username, final String fname, final String lname, final String mobile, final String email, final String password) {
