...
public class RouteParseHelper {

    static RouteParseHelper rph;

    private RouteParseHelper(){}

    public static RouteParseHelper init(){
        if (rph==null)
            rph=new RouteParseHelper();
    ...
    public List<List<HashMap<String, String>>> parse(JSONArray jLegs) {
